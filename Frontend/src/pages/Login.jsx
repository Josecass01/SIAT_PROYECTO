...
import Navbar from "../components/Navbar"; // Asegúrate de que tu Navbar existe
...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Aquí iría la lógica de autenticación (e.g. llamada a tu API con axios)
    console.log({ email, password });
    // Una vez autenticado, redirige a Home (o a la vista que corresponda)
    navigate("/");
  };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-sky-100 to-sky-200">
      ...
      <div className="flex-grow flex flex-col items-center justify-start pt-12 px-4">
        {/* Espacio entre Navbar y tarjeta */}
        <div className="bg-white rounded-xl shadow-lg w-full max-w-md">
          {/* ---------- HEADER DE LA TARJETA ---------- */}
          <div className="flex flex-col items-center pt-8">
            <div className="bg-sky-500 rounded-full p-3 mb-4">
              {/* Ícono redondo (puedes cambiarlo por el que prefieras) */}
              <svg
            ...
            <h1 className="text-2xl font-extrabold text-gray-800">
              Welcome Back to SIAT Cartagena
            </h1>
            <p className="text-gray-500 mt-1 text-center px-6">
              Log in to continue exploring Cartagena&apos;s treasures
            </p>
          </div>
